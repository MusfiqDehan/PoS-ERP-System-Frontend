# CLAUDE.md — Sortorium (Next.js, retail-pos)
...
**What it is:** the **Sortorium** retail POS / admin front-end. Front-end **only** —
no backend, API, DB, auth, or real state. Every screen renders from hardcoded JSON arrays. Static export.
Think "UI kit", not an app. `package.json` → `sortorium` 0.1.0, private.
