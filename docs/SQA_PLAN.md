# Software Quality Assurance (SQA) Plan — Sortorium

> Companion to [`README.md`](README.md) (architecture) and [`SAAS_PLAN.md`](SAAS_PLAN.md) (backend + hosting).
> This document defines **how quality is assured** across the Sortorium SaaS — test strategy, levels, process,
...
**Purpose:** ensure Sortorium is **correct, secure, and reliable** before it reaches tenants — with special
