...
import {
  ...
  unitOptions,
  warehouseOptions,
} from "@/components/Inventory/add-product/selectOptions";
    ...
    <div className="bg-white border border-[#f1f1f1] rounded-[8px] mb-4">
      ...
      <div id="SpacingOne" className="accordion-collapse collapse show">
        <div className="border-t border-[#f1f1f1] p-4">
          ...
          <div className="row">
            <FormCol>
              <TextField label="Product Name" required defaultValue="Lenovo 3rd Generation" />
            </FormCol>
            <FormCol>
              <TextField label="Slug" required defaultValue="computers" />
            </FormCol>
          </div>
          <div className="row">
            <FormCol>
