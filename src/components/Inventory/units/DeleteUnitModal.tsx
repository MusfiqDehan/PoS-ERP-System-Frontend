...
export default function DeleteUnitModal({ unit, onDeleteUnit }: Props) {
  ...
  const handleDelete = async () => {
    ...
    setDeleting(false);
    if (ok) {
      (window as any).bootstrap?.Modal?.getInstance?.(document.getElementById("delete-unit-modal"))?.hide();
    }
  };
        ...
        <div className="modal-content">
          <div className="p-5 px-3 text-center">
            ...
            <div className="mt-3 d-flex justify-content-center gap-2">
              ...
              <button type="button" className="btn btn-primary fs-13 fw-medium p-2 px-3" disabled={deleting} onClick={handleDelete}>
