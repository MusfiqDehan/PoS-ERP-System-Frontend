      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          <div className="flex items-center justify-between p-4 border-b border-[#f1f1f1]">
            <h4 className="m-0 text-[18px] font-bold text-[#212B36]">Edit Variant</h4>
            <button
              type="button"
          ...
          <form>
            <div className="p-4 flex flex-col gap-4">
              <div>
                <label className={labelCls}>Variant <span className="text-[#dc3545]">*</span></label>
                <input type="text" className={inputCls} defaultValue="Size" />
              </div>
              <div>
                <label className={labelCls}>Values <span className="text-[#dc3545]">*</span></label>
                <input type="text" className={inputCls} defaultValue="S, M, L, XL" />
                <span className="block mt-1.5 text-[12px] text-[#9aa0a6]">Enter value separated by comma</span>
              </div>
