...
export default function EditWarrantyModal() {
  const [description, setDescription] = useState<string | undefined>("Efficient Productivity");
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          <div className="flex items-center justify-between p-4 border-b border-[#f1f1f1]">
            <h4 className="m-0 text-[18px] font-bold text-[#212B36]">Edit Warranty</h4>
            <button
              type="button"
          ...
          <form>
            <div className="p-4 flex flex-col gap-4">
              <div>
                ...
                <input type="text" className={inputCls} defaultValue="Replacement Warranty" />
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className={labelCls}>Duration <span className="text-[#dc3545]">*</span></label>
                  <input type="text" className={inputCls} defaultValue="2" />
                </div>
                <div>
