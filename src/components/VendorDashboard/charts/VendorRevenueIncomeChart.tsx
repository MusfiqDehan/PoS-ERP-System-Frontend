...
const VendorRevenueChart: React.FC = () => {
  const options: ApexOptions = {
    ...
    yaxis: {
      ...
      labels: {
        offsetX: -15,
        style: { colors: "#667085", fontSize: "13px" },
  ...
  return (
    <ApexChart options={options} series={options.series} type="bar" height={230} />
  );
};
