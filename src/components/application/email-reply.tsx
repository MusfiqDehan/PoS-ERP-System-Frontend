            ...
            <div className="card shadow-none">
              <div className="card-body">
                ...
                <Lightbox
                            ...
                            slides={[
                              {
                                src: "/nextjs/template/assets/img/media/email-attach-big-01.jpg",
                              },
                              {
                                src: "/nextjs/template/assets/img/media/email-attach-big-02.jpg",
                              },
                              {
                                src: "/nextjs/template/assets/img/media/email-attach-big-03.jpg",
                              },
                            ]}
                          />
                         <Link href="#" data-fancybox="gallery" onClick={() => setOpen1(true)} className="avatar avatar-xl me-3 gallery-item">
                                <img
                                  src="/nextjs/template/assets/img/media/email-attach-01.jpg"
                                  className=" rounded"
                                  alt="img"
                                />
                         ...
                         <Link href="#" data-fancybox="gallery" onClick={() => setOpen1(true)} className="avatar avatar-xl me-3 gallery-item">
                                <img
                                  src="/nextjs/template/assets/img/media/email-attach-02.jpg"
                                  className=" rounded"
                                  alt="img"
                                />
                                <span className="avatar avatar-md avatar-rounded">
                         ...
                         <Link href="#" data-fancybox="gallery" onClick={() => setOpen1(true)} className="avatar avatar-xl me-3 gallery-item">
                                <img
                                  src="/nextjs/template/assets/img/media/email-attach-03.jpg"
                                  className=" rounded"
                                  alt="img"
                                />
                                <span className="avatar avatar-md avatar-rounded">
