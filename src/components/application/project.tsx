                                  ...
                                  <div className="bg-white p-2 rounded mb-2">
                                    <div className="d-flex align-items-center justify-content-between">
                                      <div className="d-flex align-items-center">
                                        <span className={`${column.title === 'New' ? "bg-soft-pink" : column.title === 'Inprogress' ? 'bg-soft-skyblue' : "bg-soft-danger"} p-1 d-flex rounded-circle me-2`}>
                                          <span className={`${column.title === 'New' ? 'bg-pink' : column.title === 'Inprogress' ? 'bg-skyblue' : 'bg-danger'} rounded-circle d-block p-1`} />
                                        </span>
                              ...
                              {(provided) => (
                                ...
                                >
                                  <div className="bg-white p-2 rounded mb-2">
                                    <div className="d-flex align-items-center justify-content-between">
                                      <div className="d-flex align-items-center">
                                        <span className={`${column2.title === 'New' ? "bg-soft-pink" : column2.title === 'Inprogress' ? "bg-soft-skyblue" : "bg-soft-danger"} p-1 d-flex rounded-circle me-2`}>
                                          <span className={`${column2.title === 'New' ? 'bg-pink' : column2.title === 'Inprogress' ? 'bg-skyblue' : 'bg-danger'} rounded-circle d-block p-1`} />
                                        </span>
                              ...
                              {(provided) => (
                                ...
                                >
                                  <div className="bg-white p-2 rounded mb-2">
                                    <div className="d-flex align-items-center justify-content-between">
                                      <div className="d-flex align-items-center">
                                        <span className={`${column3.title === 'New' ? "bg-soft-pink" : column3.title === 'Inprogress' ? "bg-soft-skyblue" : "bg-soft-danger"} p-1 d-flex rounded-circle me-2`}>
                                          <span className={`${column3.title === 'New' ? 'bg-pink' : column3.title === 'Inprogress' ? 'bg-skyblue' : 'bg-danger'} rounded-circle d-block p-1`} />
                                        </span>
                              ...
                              {(provided) => (
                                ...
                                >
                                  <div className="bg-white p-2 rounded mb-2">
                                    <div className="d-flex align-items-center justify-content-between">
                                      <div className="d-flex align-items-center">
                                        <span className={`${column4.title === 'New' ? "bg-soft-pink" : column4.title === 'Inprogress' ? "bg-soft-skyblue" : "bg-soft-danger"} p-1 d-flex rounded-circle me-2`}>
                                          <span className={`${column4.title === 'New' ? 'bg-pink' : column4.title === 'Inprogress' ? 'bg-skyblue' : 'bg-danger'} rounded-circle d-block p-1`} />
                                        </span>
