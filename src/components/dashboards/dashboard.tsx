          ...
          <div className="row">
              ...
              <div className="card dash-widget w-100">
                <div className="card-body d-flex align-items-center">
                  ...
                  <div className="dash-widgetcontent">
                    <h5>
                      <CountUp
                        className="counters custome-heading"
                        start={0}
                        end={307144}
                        duration={3}
                        prefix="$"
            ...
            <div className="col-xl-3 col-sm-6 col-12 d-flex">
              <div className="dash-count">
                <div className="dash-counts">
                  <h4 className="custome-heading">100</h4>
                  <h5>Customers</h5>
                </div>
            ...
            <div className="col-xl-3 col-sm-6 col-12 d-flex">
              <div className="dash-count das1">
                <div className="dash-counts">
                  <h4 className="custome-heading">110</h4>
                  <h5>Suppliers</h5>
                </div>
                <div className="dash-imgs">
                  <UserCheck />
            ...
            <div className="col-xl-3 col-sm-6 col-12 d-flex">
              <div className="dash-count das2 bg-dark">
                <div className="dash-counts">
                  <h4 className="custome-heading">150</h4>
            ...
            <div className="col-xl-3 col-sm-6 col-12 d-flex">
              <div className="dash-count das3">
                <div className="dash-counts">
                  <h4 className="custome-heading">170</h4>
                  <h5>Sales Invoice</h5>
                </div>
                <div className="dash-imgs">
                  <File />
