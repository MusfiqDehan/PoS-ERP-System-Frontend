...
export default function LeavesAdminComponent () {
  ...
  const columns = [
    {
      title: "Emp Name",
      dataIndex: "empname",
      sorter: (a:any, b:any) => a.empname.length - b.empname.length,
    },
    {
      title: "Emp Id",
      dataIndex: "empid",
    ...
    },
    {
      title: "From Date",
      dataIndex: "fromdate",
      sorter: (a:any, b:any) => a.fromdate.length - b.fromdate.length,
    },
    {
      title: "To Date",
      dataIndex: "todate",
      sorter: (a:any, b:any) => a.todate.length - b.todate.length,
    },
    {
      title: "Days/Hours",
