...
export default function PayrollListComponent () {
  ...
  const columns = [
    ...
    },
    {
      title: "Employee ID",
      dataIndex: "id2",
      sorter: (a:any, b:any) => a.id2.localeCompare(b.id2),
    },
    {
      title: "Email",
      dataIndex: "email",
                  ...
                  <div className="row">
                    ...
                    <div className="d-flex align-items-end border-bottom mb-3">
                      ...
                      <div className="subadd-btn mb-3 ms-3">
                        <Link href="#" className="btn btn-icon btn-secondary btn-add">
                    ...
                    <div className="col-lg-12">
                      <div className="d-flex align-items-center justify-content-end">
                        ...
                        <Link href="#" className="btn btn-save" data-bs-dismiss='modal'>
                          Save
                        </Link>
                      </div>
                    </div>
