                            ...
                            <div className="theme-type-images d-flex align-items-center mb-4">
                              ...
                              >
                                ...
                                <div className="theme-image-set">
                                  <img src="assets/img/theme/theme-img-08.jpg" alt="Sortorium" />
                                </div>
                                <h6>Light</h6>
                              </div>
                              <div
                              ...
                              >
                                ...
                                <div className="theme-image-set">
                                  <img src="assets/img/theme/theme-img-09.jpg" alt="Sortorium" />
                                </div>
                                <h6>Dark</h6>
                              </div>
                              <div
                              ...
                              >
                                ...
                                <div className="theme-image-set">
                                  <img src="assets/img/theme/theme-img-10.jpg" alt="Sortorium" />
                                </div>
                                <h6>Automatic</h6>
                              </div>
                            </div>
