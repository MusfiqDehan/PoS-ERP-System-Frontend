                                    ...
                                    <div className="swiper swiper-basic">
                                        <div className="swiper-wrapper">
                                            <SwiperSlide className="swiper-slide">
                                                <img src="assets/img/img-01.jpg" alt="Sortorium" />
                                            </SwiperSlide>
                                            <SwiperSlide className="swiper-slide">
                                                <img src="assets/img/img-02.jpg" alt="Sortorium" />
                                            </SwiperSlide>
                                            <SwiperSlide className="swiper-slide">
                                                <img src="assets/img/img-03.jpg" alt="Sortorium" />
                                            </SwiperSlide>
                                        </div>
                                    </div>
                                </Swiper>
                            ...
                            <div className="card-body">
                                ...
                                >
                                    <div className="swiper pagination">
                                        <div className="swiper-wrapper">
                                            <SwiperSlide className="swiper-slide">
                                                <img src="assets/img/img-04.jpg" alt="Sortorium" />
                                            </SwiperSlide>
                                            <SwiperSlide className="swiper-slide">
                                                <img src="assets/img/img-05.jpg" alt="Sortorium" />
                                            </SwiperSlide>
                                            <SwiperSlide className="swiper-slide">
                                                <img src="assets/img/img-01.jpg" alt="Sortorium" />
                                            </SwiperSlide>
