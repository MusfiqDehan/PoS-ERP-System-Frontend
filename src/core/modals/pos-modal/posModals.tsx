                      ...
                      <div className="card bg-light mb-3">
                        <div className="card-body">
                          ...
                          <div className="d-flex align-items-center justify-content-center flex-wrap gap-2">
                            <Link href="#" className="btn btn-md btn-orange">
                              Open Order
                            </Link>
                            <Link
                              href="#"
                            ...
                            <Link href="#" className="btn btn-md btn-indigo">
                              Print
                            </Link>
                          </div>
                        </div>
            ...
            <div className="modal-body p-0">
              ...
              <div className="success-wrap scan-wrap text-center">
                ...
                <div className="scan-img">
                  <img src="assets/img/icons/scan-img.svg" className="scan-image" alt="img" />
                  <img
                    src="assets/img/icons/scan-img-white.svg"
                    className="scan-img-white"
                    alt="img"
                  />
                </div>
                <p className="mb-3">
            ...
            <div className="modal-body p-0">
              <div className="success-wrap">
                ...
                <div className="d-flex align-items-center justify-content-center gap-2 flex-wrap">
                  ...
                  <Link href="#" className="btn btn-md btn-dark flex-fill">
            ...
            <form>
              <div className="modal-body">
                ...
                <div className="text-end">
                  <Link href="#" className="btn btn-primary btn-md add-item">
                    Add More
                  </Link>
                </div>
              </div>
                  ...
                  <div className="col-md-12">
                    ...
                    <div className="point-wrap payment-content mb-3">
                      <div className=" bg-success-transparent d-flex align-items-center justify-content-between flex-wrap p-2 gap-2 br-5">
                        ...
                        <Link href="#" className="btn btn-dark btn-md">
